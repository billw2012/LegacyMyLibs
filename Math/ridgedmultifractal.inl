...
RidgedMultifractalComposer<FTy_, NPTy_>::RidgedMultifractalComposer(
...
template < class FTy_, class NPTy_ >
typename RidgedMultifractalComposer<FTy_, NPTy_>::value_type 
RidgedMultifractalComposer<FTy_, NPTy_>::operator()(const SSEVectorType& exponents, 
...
typename RidgedMultifractalComposer<FTy_, NPTy_>::value_type 
	...
	const noise_provider* noisep,
	value_type lacunarity, value_type octaves, 
	value_type vx, value_type vy) const
{
	value_type result, /*frequency, */signal, weight;
...
#ifdef ENABLE_SSE
template < class FTy_, class NPTy_ >
typename RidgedMultifractalComposer<FTy_, NPTy_>::sse_type 
RidgedMultifractalComposer<FTy_, NPTy_>::operator()(const SSEVectorType& exponents, 
...
RidgedMultifractalComposer<FTy_, NPTy_>::eval(const SSETraits<double>::Vector& exponents, 
					const noise_provider* noisep, const value_type* lacunarity, 
...
RidgedMultifractalComposer<FTy_, NPTy_>::eval(const SSETraits<float>::Vector& exponents, 
											  const noise_provider* noisep, const value_type* lacunarity, 
