...
>
struct RidgedMultifractalComposer //: public SpectralComposerBase< FloatType, NoiseProvider >
{
	...
	typedef RidgedMultifractalComposer< FloatType, NoiseProvider > this_type;

private:
	value_type _offset, _gain;

public:
	RidgedMultifractalComposer(value_type offset = 1.0, value_type gain = 2.0);
